...
Esta posición es, a primera vista, razonable. Sin embargo, no todas las expresiones matemáticas en física tienen el mismo estatus. **Hay expresiones que un estudiante debe haber interiorizado contextualmente.** Nadie espera que un físico competente memorice la fórmula de la braquistócrona (aunque sin duda habrá expertos que la recuerden), pero si un estudiante de mecánica no puede recordar las tres leyes de Newton y sus expresiones matemáticas fundamentales, es muy difícil argumentar que domina la materia. Tener la información básica y elemental memorizada es un indicador de dominio.

Aquí es donde mi mensaje explícito a los estudiantes aborda esta aparente contradicción:
...
Dar la lista de fórmulas a estudiantes de cursos introductorios es contraproducente porque, precisamente, les roba la oportunidad de desarrollar la habilidad de recordar o deducir. Al no exigírselo, les decimos que *está bien no saber cómo se llega a esa expresión*. Esto, en mi opinión, fomenta una visión errónea de la ciencia, viéndola como una simple colección de fórmulas para "enchufar y resolver".
